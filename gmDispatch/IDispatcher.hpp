 ...
 *
 * A dispatcher receives an @ref Envelope from the @ref GmDispatcher facade,
 * routes it to all subscribed @ref IChannel instances, and manages the
 * subscription lifecycle.
 *
 * This abstraction decouples the @ref GmDispatcher facade from the question of
 ...
 *
 * The @ref GmDispatcher facade holds a @c std::unique_ptr<IDispatcher>, so
