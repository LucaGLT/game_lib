...
# Markdown Style Instructions — game_lib
...
- C++ style rules (tabs, Allman braces, line-length rules for code) do not apply to Markdown prose.
...
- Wrap prose naturally for readability; do not force C++ column rules onto Markdown text.
